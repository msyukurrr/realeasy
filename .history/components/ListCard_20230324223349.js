        ...
        <div className={styles.cardCont}>
            ...
            <div className={styles.textCont}>
                ...
                <div className={styles.cardTxt}>
                    ...
                    <Image src={agency?.logo?.url} width={80} height={20} style={{objectFit:'fit'}}/> 
                    </span>
                    <p style={{marginLeft:20, marginBottom:-10, marginTop:-10}}><FaBath/>{rooms}</p>
                    <p style={{marginLeft:20}}>{baths}</p>
                </div>
